    ...
    return (
        ...
        <div className="h-100 w-50 max-auto d-flex aligns-items-center justify-content-center flex-column">
            <div>
                ...
                <p class="text-center ps-5 pe-5">I grew up in sunny Southern California and now reside in the Bay Area.
                  ...
                  I love to code. Wanting to pivor into engineering, I enrolled in Hackbright. 
